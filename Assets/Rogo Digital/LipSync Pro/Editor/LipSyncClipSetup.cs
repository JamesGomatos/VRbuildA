...
#pragma warning disable 618
	...
	private const string versionNumber = "Pro 1.3";
	...
	void SaveFile (string path, bool isXML) {
		if (isXML) {
			...
			foreach (PhonemeMarker marker in phonemeData) {
				...
				writer.WriteAttributeString("phoneme", this.settings.phonemeSet.phonemes[marker.phonemeNumber].name);
